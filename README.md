...
État de production au 2026-07-30 : les PR [#7](https://github.com/Shaaakir281/nepteo/pull/7), [#8](https://github.com/Shaaakir281/nepteo/pull/8) et [#9](https://github.com/Shaaakir281/nepteo/pull/9) ont été fusionnées dans `main`. Azure sert l'image immutable `5d03f109e9d06c456781d72c2c0b5ab13eca1a4c`, révision `nepteo-prod--0000006`, avec 100 % du trafic. `/`, `/api/health` et `/api/ready` répondent HTTP 200. Le smoke applicatif authentifié en lecture est propre ; l'isolation RLS multi-rôles/tenants, les callbacks OAuth, le retrait contrôlé du marqueur démo orphelin et les parcours avec mutation restent à recetter sur des fixtures dédiées.

Lot livré : les lectures prospects partagent une cohorte complète, les conflits multi-source sont réconciliés prudemment et les snapshots de relance restent stables pendant les synchronisations. L'interface distingue désormais les 24 contacts regroupés pour la lecture des 29 identités conservées par prudence pour les décisions, et explique pourquoi les connecteurs réels restent bloqués tant que le marqueur démo orphelin n'est pas retiré. Validation de référence : **341/341 tests**, lint, typecheck et build de production (23 pages/routes) verts.
