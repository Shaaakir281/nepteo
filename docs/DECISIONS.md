...
| 2 | Premier connecteur (CRM ? analytics ? Stripe ?) | Dépend du n°1 | Bloquée par n°1 |
| 3 | File de jobs : pg-boss vs BullMQ | pg-boss = pas d'infra Redis ; BullMQ = plus riche | À trancher |
